...
This document describes how to calculate the TXID for atc.
...
To learn more about txid calculation, please read the code [here](https://github.com/atc-labs/aitcoin/blob/master/src/hash.h#L239-L274).
