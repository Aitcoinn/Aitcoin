# ATC version 0.2.0 Release Notes
...
Mentioned above, the "`-chaininitparam`" must be deleated from atc.conf.
...
More details [here](https://github.com/atc-labs/atc-assets-indexer) .

* Add fixed seed nodes and the script (in python) to generate list of seed nodes.

[/util/seeds/README.md](../util/seeds/README.md)

* Add some macro definitions for new chain creation from ATC.
...
# Previous Releases
* [Version 0.1.2](release-notes-v0.1.2.md) - [Download](https://github.com/atc-labs/atc-mining-instruction/releases/download/v0.1.2.0/atc.tar.gz) - [Source](https://github.com/atc-labs/atc-mining-instruction/archive/refs/tags/v0.1.2.0.zip) - 2023-1-28
* [Version 0.1.3](release-notes-v0.1.3.md) - [Download](https://github.com/atc-labs/atc-mining-instruction/releases/download/v0.1.3.0/atc.tar.gz) - [Source](https://github.com/atc-labs/atc-mining-instruction/archive/refs/tags/v0.1.3.0.zip) - 2023-4-3
* [Version 0.1.3.1](release-notes-v0.1.3.1.md) - [Download](https://github.com/atc-labs/atc-mining-instruction/releases/download/v0.1.3.1/atc.tar.gz) - [Source](https://github.com/atc-labs/atc-mining-instruction/archive/refs/tags/v0.1.3.1.zip) - 2023-4-24
* [Version 0.1.4](release-notes-v0.1.4.md) - [Download](https://github.com/atc-labs/atc-mining-instruction/releases/download/v0.1.4.0/atc.tar.gz) - [Source](https://github.com/atc-labs/atc-mining-instruction/archive/refs/tags/v0.1.4.0.zip) - 2023-6-6
