...
const char *const IXC_CONF_FILENAME = "atc.conf";
const char *const IXC_PID_FILENAME = "aitcoind.pid";
...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\ATC
// Windows >= Vista: C:\Users\Username\AppData\Roaming\ATC
// Mac: ~/Library/Application Support/ATC
// Unix: ~/.atc
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ATC";
#else
    fs::path pathRet;
...
#ifdef __APPLE__
    // Mac
    return pathRet / "Library/Application Support/ATC";
#else
    // Unix
    return pathRet / ".atc";
#endif
