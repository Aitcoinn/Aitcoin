 ...
 *
 * See https://aitcointalk.org/index.php?topic=8392.msg127623#msg127623
 *
        ...
        while (pc < pend) {
            ...
            if (fExec && 0 <= opcode && opcode <= OP_PUSHDATA4) {
                ...
                switch (opcode) {
                    ...
                    case OP_DEPTH: {
                        // -- stacksize
                        const CScriptNum bn(atc::bint{stack.size()});
                        stack.push_back(bn.getvch());
                    } break;
                    ...
                    case OP_SIZE: {
                        ...
                        CScriptNum bn(atc::bint{stack.stacktop(-1).size()});
                        stack.push_back(bn.getvch());
                    } break;
