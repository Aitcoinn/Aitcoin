...
public:
    ...
    atc::instruction_iterator begin_instructions() const;
    atc::instruction_iterator end_instructions() const;
    ...
    /**
     * Pre-version-0.6, ATC always counted CHECKMULTISIGs as 20 sigops. With
...
bool IsP2SH(atc::span<const uint8_t>);
bool IsDSNotification(atc::span<const uint8_t>);
bool IsDustReturnScript (atc::span<const uint8_t> script);


size_t CountOp(atc::span<const uint8_t>, opcodetype);
