...
bool Solver(const CScript &scriptPubKey, 
    ...
    static std::multimap<txnouttype, CScript> mTemplates{
            ...
            // ATC address tx, sender provides hash of pubkey, receiver
        ...
        while (true) {
            if (pc1 == script1.end() && pc2 == script2.end()) {
                ...
                if (typeRet == TX_MULTISIG) {
                    ...
                    if (!atc::IsMinimallyEncoded(vSolutionsRet.front(), CScriptNum::MAXIMUM_ELEMENT_SIZE) ||
                        !atc::IsMinimallyEncoded(vSolutionsRet.back(), CScriptNum::MAXIMUM_ELEMENT_SIZE)){
                        typeRet = TX_NONSTANDARD;
                        return false;
                    }
