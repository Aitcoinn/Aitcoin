...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("seed1.aitcoin.com", "seed1.aitcoin.com"));
        vSeeds.push_back(CDNSSeedData("seed2.aitcoin.com", "seed2.aitcoin.com"));
        ...
        chainTxData = ChainTxData{
            ...
            // (the tx=... number in the SetBestChain aitcoind.log lines)
            5545024,
