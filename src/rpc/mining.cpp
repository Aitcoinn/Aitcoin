                      ...
                      bool processedInBatch = true)
{
    if (request.fHelp || request.params.size() > 1) {
        throw std::runtime_error(
            ...
            "    "
            "https://github.com/atc/bips/blob/master/bip-0022.mediawiki\n"
            "    "
            "https://github.com/atc/bips/blob/master/bip-0023.mediawiki\n"
            "    "
            "https://github.com/atc/bips/blob/master/"
            "bip-0009.mediawiki#getblocktemplate_changes\n"
            "    "
            "https://github.com/atc/bips/blob/master/bip-0145.mediawiki\n"
    ...
    {
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "ATC is not connected!");
    }

    if (IsInitialBlockDownload()) {
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD,
                           "ATC is downloading blocks...");
    }
...
static UniValue verifyblockcandidate(const Config &config,
    ...
    if (request.fHelp || request.params.size() < 1 ||
        ...
        throw std::runtime_error(
            ...
            "See https://en.atc.it/wiki/BIP_0022 for full specification.\n"
