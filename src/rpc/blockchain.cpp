...
static UniValue getvestinginfo(const Config &config, const JSONRPCRequest &request) {
    if (request.fHelp || request.params.size() != 0) {
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"total_vesting_amount\": xxxxx,  (numeric) Total vesting amount in ATC\n"
            ...
            "  \"total_vested\": xxxxx,           (numeric) Total vested so far in ATC\n"
            "  \"total_locked\": xxxxx,           (numeric) Total still locked in ATC\n"
            "  \"tranches\": [                    (array) Vesting tranches detail\n"
            "    {\n"
            "      \"tranche\": x,               (numeric) Tranche number\n"
            "      \"amount_ixc\": xxxxx,         (numeric) Amount in ATC\n"
