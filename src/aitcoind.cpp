 ...
 *
 * This is the developer documentation of AITCOIN
 * (https://www.aitcoin.com/). ATC is a client for the digital
 * currency called AITCOIN, which enables
 * instant payments to anyone, anywhere in the world. AITCOIN uses
...
bool AppInit(int argc, char *argv[]) {
    ...
    if (gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") ||
        ...
        if (gArgs.IsArgSet("-version")) {
            ...
            strUsage += "\n" + HelpMessage(HMM_AITCOIND, config);
        }
    ...
    try {
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) &&
                !boost::algorithm::istarts_with(argv[i], "atc:"))
                fCommandLine = true;

        if (fCommandLine) {
            fprintf(stderr, "Error: There is no RPC client functionality in "
                            "aitcoind anymore. Use the aitcoin-cli utility "
                            "instead.\n");
            exit(EXIT_FAILURE);
        }
        // -server defaults to true for aitcoind
        ...
        if (gArgs.GetBoolArg("-daemon", false)) {
            ...
            fprintf(stdout, "\033[1;40;34m▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒\033[0m\n"
                            "\033[1;40;34m▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒\033[0m\033[1;40;32m╭━╮╭━╮╭╮  ╭╮╭━━━╮\033[0m\033[1;40;34m▒▒▒▒\033[0m\033[1;40;31mAITCOIN!\033[0m\033[1;40;34m▒▒▒▒\033[0m\n"
...
int main(int argc, char *argv[]) {
    ...
    // Connect aitcoind signal handlers
    noui_connect();
